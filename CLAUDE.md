...
## What's Next
1. `edit.html` + `js/pages/edit.js` — edit an existing material; loads live JSON by slug, pre-fills the submit form, downloads corrected JSON for replacement in repo (admin workflow)

...
5. Admin runs `python tools/update_manifest.py` locally and commits the updated `materials/index.json` to `main`
...
- [ ] `commonly_available` set appropriately
- [ ] New references added to `references/index.json`

---

## Build Order

1. `schema/v1.json` — formal schema; everything else depends on this contract
2. `references/index.json` — seed with the Paquin 1997 reference
3. `materials/metals/aluminum-6061-t6.json` + 2 seed materials from other categories
4. `tools/validate.py` · `tools/update_manifest.py` · `tools/requirements.txt`
5. `materials/index.json` — generated by running `update_manifest.py`
6. `js/core/units.js`
7. `js/core/loader.js` · `js/core/store.js`
8. `js/core/derived.js` · `js/core/schema.js` · `js/core/tooltips.js`
9. `index.html` · `js/pages/browse.js` · CSS
10. `material.html` · `js/pages/detail.js`
11. `compare.html` · `js/pages/compare.js`
12. `submit.html` · `js/pages/submit.js`

...
## Material Coverage (64 materials)
...
| Plastics (13) | ABS, Acrylic (PMMA), Nylon 6 (PA6), Nylon 12 (PA12), PEEK, PETG-FDM, PHA-FDM, PLA-FDM, Polycarbonate (PC), POM (Delrin), UHMW-PE, Vespel SP-1 (Polyimide), Vespel SP-3 (MoS₂-Filled Polyimide) |
